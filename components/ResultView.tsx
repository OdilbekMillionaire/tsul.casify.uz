...
import { LegalMemo, CaseData, Translations, ViewState } from '../types';
import { Printer, Copy, RefreshCw, AlertTriangle, CheckSquare, Briefcase, FileText, Check, Loader2 } from 'lucide-react';
...
const ResultView: React.FC<ResultViewProps> = ({ memo, caseData, t, setView }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen pt-20 pb-12 px-4 gap-8 container mx-auto fade-in-up">
      ...
      <aside className="lg:w-1/4 space-y-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 sticky top-24">
            ...
            <div className="space-y-4 text-sm">
                ...
                <div>
                    <span className="block text-gray-500 text-xs uppercase tracking-wide">Parties</span>
                    <span className="font-medium text-gray-900">{caseData.claimant} v. {caseData.respondent}</span>
                </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden print:shadow-none print:border-none">
            ...
            <div className="bg-navy-900 text-white p-8 md:p-12 text-center print:bg-white print:text-black">
                <div className="flex items-center justify-center gap-2 mb-4 opacity-75">
                    ...
                    <span className="font-serif tracking-widest uppercase text-sm">Privileged & Confidential</span>
                </div>
                <h1 className="font-serif text-3xl md:text-4xl font-bold mb-4">{memo.title}</h1>
                <p className="text-gray-300 max-w-2xl mx-auto italic print:text-gray-600">Generated by Casify AI • {new Date().toLocaleDateString()}</p>
            </div>
...
// Quick helper icon component to avoid repeating lucide import
